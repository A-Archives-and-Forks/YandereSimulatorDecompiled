					...
					if (flag)
					{
						...
						else
						{
							...
							if (!Student.StudentManager.Eighties && Student.StudentID == 12)
							{
								...
								Student.Bento.transform.localPosition = new Vector3(0f, 0.501f, -0.2533333f);
							}
						}
