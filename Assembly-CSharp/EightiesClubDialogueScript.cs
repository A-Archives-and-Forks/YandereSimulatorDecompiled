...
public class EightiesClubDialogueScript : MonoBehaviour
{
	...
	public void UpdateDialogue(int ClubID)
	{
		if (ClubID == 1)
		{
			...
			Subtitle.ClubAccepts[ClubID] = "Oh, that's wonderful! Welcome to the club! I hope you enjoy your time with us!";
			...
			Subtitle.Club1Clips[3] = AmaiLines[3];
			Subtitle.ClubJoinClips[ClubID] = AmaiLines[4];
			Subtitle.ClubAcceptClips[ClubID] = AmaiLines[5];
			Subtitle.ClubRefuseClips[ClubID] = AmaiLines[6];
			Subtitle.ClubExclusiveClips[ClubID] = AmaiLines[7];
			Subtitle.ClubQuitClips[ClubID] = AmaiLines[8];
			Subtitle.ClubConfirmClips[ClubID] = AmaiLines[9];
			Subtitle.ClubDenyClips[ClubID] = AmaiLines[10];
			Subtitle.ClubEarlyClips[ClubID] = AmaiLines[11];
			Subtitle.ClubLateClips[ClubID] = AmaiLines[12];
			Subtitle.ClubActivityClips[ClubID] = AmaiLines[13];
			Subtitle.ClubYesClips[ClubID] = AmaiLines[14];
			Subtitle.ClubNoClips[ClubID] = AmaiLines[15];
			Subtitle.ClubRejoinClips[ClubID] = AmaiLines[16];
			Subtitle.ClubKickClips[ClubID] = AmaiLines[17];
